...
import { makeStyles, Stepper, Step, StepLabel, StepContent, 
        Button, Typography, Paper, Select, TextField, Radio, RadioGroup, FormControlLabel, FormControl } from "@material-ui/core";
                    ...
                    <div>
                      ...
                      {widget === 'slider' ?
                        <div>
                          ...
                          {preview === true ?
                          <div>
                            <Manipulate binding={props.binding}></Manipulate>
                          </div> : ''                   
                          }
                        </div> 
                      : <div>
...
class Bindings extends Component {
    ...
    setSlider ( key, val ) {
      let state = this.state;
      state.binding.sourcecode.parameter[0].uiWidget[key] = val;
      this.setState(state);
    }
    ...
    render() {
      ...
      return (
          <div style={{height:'100%'}}>
              <div style={{width:'60%', float:'left', height:'70vh', overflow:'auto'}}
                onMouseUp={this.handleMouseUp.bind(this)}>
                <CodeView code={this.props.codefile.data} />
              </div>
              <div style={{height:'100%'}}>
