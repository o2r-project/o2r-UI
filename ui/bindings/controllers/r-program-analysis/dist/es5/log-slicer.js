...
var ExecutionLogSlicer = /** @class */ (function () {
    ...
    ExecutionLogSlicer.prototype.sliceAllExecutions = function (cellId, seedLocations) {
        ...
        return this.executionLog
            ...
            // Slice the program
            var sliceLocations = slice_1.slice(program.tree, seedLocations, _this.dataflowAnalyzer).items.sort(function (loc1, loc2) { return loc1.first_line - loc2.first_line; });
            ...
            var cellSlices = cellOrder.map(function (sliceCell) { return new cellslice_1.CellSlice(sliceCell, cellSliceLocations[sliceCell.executionEventId], cellExecutionTimes[sliceCell.executionEventId]); });
    ...
    ExecutionLogSlicer.prototype.getDependentCells = function (executionEventId) {
        ...
        var seedLocations = new (slice_1.LocationSet.bind.apply(slice_1.LocationSet, [void 0].concat(lines.items.map(function (line) {
