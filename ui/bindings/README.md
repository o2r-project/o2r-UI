...
After the type is added to each object, it is processed differently depending on the type. The corresponding code can be found [here](./controllers/rules.js#154-178). At the end, a possible result looks like this:
```javascript
 [...,{
    "json": {
